...
function FilterElement({
  ...
  const isSelected = params.get(queryName) === queryValue;
    ...
    return (
      <li className="flex justify-evenly items-center uppercase p-4 font-normal">
        <input
          ...
          className="text-fontPrimary-700 border border-primary-600 bg-accent-500 outline-none p-2 w-20 focus:border-primary-500"
          placeholder="min"
        />
